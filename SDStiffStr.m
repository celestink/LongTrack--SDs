...
%   plot(StiffSD_4,StressMax_4,'r')
  xlabel('Track stiffness SD \it(MPa)','FontName','Times New Roman', 'FontSize',ft);
  ylabel('Maximum longitudinal stress \it(MPa)','FontName','Times New Roman',  'FontSize',ft);
legend('mean stiffness=200MPa')
 figure(2)
...
%  plot(StiffSD_3,stressAv_3,'b'),hold on; 
 ...
 % plot(StiffSD_4,stressAv_4,'r');
  xlabel('Track stiffness SD \it(MPa)','FontName','Times New Roman', 'FontSize',ft);
  ylabel('Average maximum longitudinal stress \it(MPa)','FontName','Times New Roman',  'FontSize',ft);
legend('mean stiffness=200MPa')
...
%  plot(StiffSD_3,stressAv_3,'b'),hold on; 
 ...
 % plot(StiffSD_4,stressAv_4,'r');
  xlabel('Track stiffness SD \it(MPa)','FontName','Times New Roman', 'FontSize',ft);
  ylabel('Average maximum principal stress \it(MPa)','FontName','Times New Roman',  'FontSize',ft);
legend('mean stiffness=200MPa')
figure(4)
...
%   plot(StiffSD_4,StressMax_4,'r')
  xlabel('Track stiffness SD \it(MPa)','FontName','Times New Roman', 'FontSize',ft);
  ylabel('Maximum principal stress \it(MPa)','FontName','Times New Roman',  'FontSize',ft);
legend('mean stiffness=200MPa')
...
%   plot(StiffSD_4,StressMax_4,'r')
  xlabel('Track stiffness SD \it(MPa)','FontName','Times New Roman', 'FontSize',ft);
  ylabel('Track Stiffness Average\it(MPa)','FontName','Times New Roman',  'FontSize',ft);
legend('mean stiffness=200MPa')
